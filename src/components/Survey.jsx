...
function Survey() {
  ...
  if (answersList.length > 0){
    ...
    <li>
      <label
        ><input name="timeSpent" type="checkbox" value="bathing" onChange={handleChange}/>Bathing</label
      >
    </li>
    <li>
      <label
    ...
    <li>
      <label
        ><input name="timeSpent" type="checkbox" value="noTime" onChange={handleChange}/>I don't like to
